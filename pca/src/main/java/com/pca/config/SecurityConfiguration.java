    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/app/rest/team/**").permitAll()
                ...
                .antMatchers("/managers").hasAuthority(AuthoritiesConstants.ADMIN)
                .antMatchers("/players").hasAuthority(AuthoritiesConstants.USER)
                .antMatchers("/player/**").hasAuthority(AuthoritiesConstants.USER)
                .antMatchers("/statistics").hasAuthority(AuthoritiesConstants.USER)
