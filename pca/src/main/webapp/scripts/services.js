...
pcaApp.factory('LanguageService', ['$http', '$translate',
...
pcaApp.factory('Register', ['$resource',
    function ($resource) {
        return $resource('app/rest/register', {}, {
        });
    }]);

pcaApp.factory('Activate', ['$resource',
    function ($resource) {
...
pcaApp.factory('Account', ['$resource',
    function ($resource) {
        return $resource('app/rest/account', {}, {
        });
    }]);

pcaApp.factory('Password', ['$resource',
    function ($resource) {
        return $resource('app/rest/account/change_password', {}, {
        });
    }]);

pcaApp.factory('Sessions', ['$resource',
    function ($resource) {
...
pcaApp.factory('MetricsService', ['$resource',
    function ($resource) {
...
pcaApp.factory('ThreadDumpService', ['$http',
    function ($http) {
        return {
            dump: function() {
...
pcaApp.factory('HealthCheckService', ['$rootScope', '$http',
...
pcaApp.factory('LogsService', ['$resource',
    function ($resource) {
...
pcaApp.factory('AuditsService', ['$http',
    function ($http) {
        return {
            findAll: function() {
